...
namespace HTTPParser {
	...
	HTTPParser::RequestStatus parseChunkedBody(std::string& raw, std::string& body);
	...
	bool parseBody(std::string& rawBody, const std::map<std::string, std::string>& headers, std::string& body);
	...
	HTTPParser::RequestStatus checkComplete(Connection& c);
}
